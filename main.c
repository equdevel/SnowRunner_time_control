...
int WINAPI WinMain(HINSTANCE hThisInstance, HINSTANCE hPrevInstance, LPSTR lpszArgument, int nCmdShow) {
    ...
    RegisterHotKey(NULL, ALT_7, MOD_NOREPEAT | MOD_ALT, VK_NUMPAD7);
    RegisterHotKey(NULL, ALT_8, MOD_NOREPEAT | MOD_ALT, VK_NUMPAD8);
    RegisterHotKey(NULL, ALT_9, MOD_NOREPEAT | MOD_ALT, VK_NUMPAD9);
